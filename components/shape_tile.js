export default function getShapeTile(id, title, isSelected, deleteListener){
    ...
    container.style = "min-width: 100px; border: 2px, solid, black; border-radius: 4px; padding: 2px; display: flex; flex-direction: row; justify-content: space-between; box-sizing: border-box;";
